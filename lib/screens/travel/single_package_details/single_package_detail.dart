...
class _SinglePackageDetailsState extends State<SinglePackageDetails>{
  ...
  Widget build(BuildContext context) {
    ...
    if(data == null)
      ...
      itineraryItems = new List.generate(data["itinerary"].length, (i)=> _buildItinerary(i));
          ...
          body: ListView(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(widget.package.title,
                  style: TextStyle(
              ...
              Padding(
                ...
                child: Text(widget.package.nights + " NIGHTS " + widget.package.days + " DAYS",
                  style: TextStyle(
            ...
            onTap: (){
              Navigator.push(context, MaterialPageRoute(
                builder: (BuildContext context) => ImageGallery(
                  ...
                  image1: NetworkImage(data["images"][0]),
                  image2: NetworkImage(data["images"][1]),
                  image3: NetworkImage(data["images"][2]),
                  image4: NetworkImage(data["images"][3]),
                  index: index,
                )
              ));
            },
